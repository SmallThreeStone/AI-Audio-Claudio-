...
async def _build_queue_response(db: AsyncSession, s: DJSession, initiator_client_id: str = "") -> dict:
    ...
    # Songs in the library should always be playable — if a URL expired, just refresh it.
    ...
    for qi in items:
        ...
        if qi.item_type == "song" and qi.song_id and qi.status != "error" and not revived and not qi.stream_url:
